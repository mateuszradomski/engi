...
Wraz z premierą architektury \textbf{\textit{Fermi TESLA}} w mikroprocesorach firmy \textit{NVIDIA}, wprowadzono pojęcie multi-procesora strumieniowego (ang. Streaming Multiprocesor), w skrócie \textit{SM}.
