...
for directory in dirs:
    ...
    for i,f in enumerate(glob.glob("*json")):
        ...
        ELEMENT_BYTE_SIZE = 4
        size = info["non_zero_count"] * ELEMENT_BYTE_SIZE
...
ylabel = "GB/s"
title = "Efektywna przepustowość pamięci różnych formatów macierzy w SpMV dla wybranych macierzy"
outfilename = "plots\\barchart_memory_effective_tput.png"
myplot(kd, len(dirs), xticklabels, ylabel, 100, title, outfilename)
