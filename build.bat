...
glslc.exe -O -fshader-stage=comp ..\..\shaders\sparse_matmul_sell_column_major.glsl -o sparse_matmul_sell_column_major.spv
...
@REM set "COMP_FLAGS=-fsanitize=address -fsanitize=undefined"
set "COMP_FLAGS="
